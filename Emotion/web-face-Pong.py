...
##### LEO SECTION
            ...
            try:
                im = io.imread('http://193.205.243.225:49227/out.jpg')
            except:
        ...
        #    im = Image.fromarray(np.uint8(arr))
            ...
            for face_coordinates in faces:
                ...
                ### LEO ADDED: just to stop Neutral emotions....
#                emotion_prediction[-1] = 0
                ...
                if emotion_text != last_emotion_text:
                    human_agent_action = 5 - human_agent_action
